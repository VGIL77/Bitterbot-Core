                ...
                {activeTab === 'terms' ? (
                  <div>
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      ...
                      CAREFULLY BEFORE USING THE SERVICES OFFERED BY BitterBot AI
                      Corp (701 Tillery Street Unit 12-2521 Austin, Texas 78702,
                      United States). THIS AGREEMENT SETS FORTH THE LEGALLY
                      BINDING TERMS AND CONDITIONS FOR YOUR USE OF THE BITTERBOT
                    ...
                    <ul className="text-muted-foreground space-y-1 mb-6">
                      <li>
                        "Company" refers to BitterBot AI Corp (701 Tillery Street
                        Unit 12-2521 Austin, Texas 78702, United States).
                      </li>
                      <li>
                        "Site" refers to the BitterBot website, including any related
                        features, content, or applications offered from time to
                        time by the Company.
                      </li>
                      <li>
                        "Service" refers to the BitterBot website and all related
                      ...
                      <li>
                        ...
                        Company, specifically legal@bitterbot.ai
                      </li>
                      <li>
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      BitterBot is licensed under the Apache License, Version 2.0.
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      ...
                      please write to legal@bitterbot.ai and we will process and
                    ...
                    <p className="text-muted-foreground text-balance mb-4">
                      ...
                      or by emailing us at legal@bitterbot.ai. If you cancel
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      All BitterBot logos, marks, and designations are trademarks or
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      ...
                      LIMITATION, THE BITTERBOT WEB APP AND ANY CONTENT) IS PROVIDED
                      ...
                      BITTERBOT DOES NOT GUARANTEE THE ACCURACY, COMPLETENESS, OR
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      ...
                      by emailing us at{' '}
                      <a
                        href="mailto:legal@bitterbot.ai"
                        className="text-secondary hover:underline"
                      >
                        legal@bitterbot.ai
                      </a>
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      References to our "Services" at BitterBot in this statement
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      BitterBot does not collect biometric or identifying
