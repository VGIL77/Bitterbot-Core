...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  const fallbackMetaData = {
    title: 'Shared Conversation | Bitterbot',
    description: 'Replay this Agent conversation on Bitterbot',
    alternates: {
  ...
  try {
    ...
    const title = projectData.name || 'Shared Conversation | Bitterbot';
    const description =
      projectData.description ||
      'Replay this Agent conversation on Bitterbot';
