      ...
      <div className="flex flex-col w-full h-auto gap-4 justify-between">
        <div className="flex gap-2 items-center px-2">
          <Textarea
            ...
            className={cn(
              'w-full bg-transparent dark:bg-transparent border-none shadow-none focus-visible:ring-0 focus:ring-0 focus:outline-none focus-visible:outline-none px-2 py-1 text-base min-h-[40px] max-h-[200px] overflow-y-auto resize-none',
          ...
          {subscriptionStatus === 'no_subscription' && !isLocalMode() &&
            <TooltipProvider>
              <Tooltip>
                ...
                <TooltipContent>
                  <p>The free tier is severely limited by inferior models; upgrade to experience the true full BitterBot experience.</p>
                </TooltipContent>
              </Tooltip>
            </TooltipProvider>
          }
          <div className='flex items-center gap-2'>
            {/* Model selector hidden as per BitterBot requirements */}
