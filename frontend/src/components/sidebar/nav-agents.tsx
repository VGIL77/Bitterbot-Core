...
export function NavAgents() {
  ...
  const displayedThreads = combinedThreads;
  ...
  return (
    <SidebarGroup>
      <div className="px-2 mb-2">
        {state !== 'collapsed' && (
          <Link href="/dashboard" className="block">
            <button 
              className="w-full bg-transparent border-2 border-[#00D4E6] text-[#00D4E6] 
                        hover:bg-[#00D4E6]/10 hover:shadow-[0_0_20px_rgba(0,212,230,0.3)] 
                        hover:-translate-y-px transition-all duration-300 
                        py-3 px-6 rounded-lg font-semibold
                        focus:animate-[pulse-border_2s_infinite] focus:outline-none"
            >
              New Task
            </button>
          </Link>
      ...
      <div className="flex justify-between items-center px-2">
        <SidebarGroupLabel className="text-[#00D4E6] text-xs uppercase tracking-wider font-semibold">
          Previous Chats
        </SidebarGroupLabel>
      </div>
      ...
      <SidebarMenu className="overflow-y-auto max-h-[calc(100vh-200px)]">
        ...
        {isLoading ? (
          ...
          // Show threads with project info
          <>
                      ...
                      <TooltipTrigger asChild>
                        <div>
                          <SidebarMenuButton
                            asChild
                            className={`${
                              isActive ? 'bg-purple-500/10 text-white border border-purple-500/30' :
                                isSelected ? 'bg-primary/10' : 'text-gray-400 hover:text-purple-200 hover:bg-purple-500/5'
                    ...
                    <div className="relative">
                      <SidebarMenuButton
                        ...
                        className={`relative ${isActive
                          ? 'bg-purple-500/10 text-white font-medium border border-purple-500/30'
                          : isSelected
                            ? 'bg-primary/10'
                            : 'text-gray-400 hover:text-purple-200 hover:bg-purple-500/5 hover:border-purple-500/10 border border-transparent'
                          } transition-all duration-200`}
                      >
                        <Link
                          href={thread.url}
