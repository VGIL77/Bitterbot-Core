        ...
        <div className={cn("flex items-center", className)}>
          <DropdownMenu open={isOpen} onOpenChange={setIsOpen}>
            <DropdownMenuTrigger asChild>
              ...
              >
                {displayName === 'BitterBot' ? (
                  <span className="tracking-tight text-4xl font-semibold leading-tight">
                ...
                <div className="flex items-center opacity-60 group-hover:opacity-100 transition-opacity" style={{ display: 'none' }}>
              ...
              >
                <div className="flex items-center gap-2 w-full">
                  ...
                  <div className="flex items-center gap-1 flex-1 min-w-0">
                    <span className="font-medium truncate">BitterBot</span>
