      ...
      <div className="w-full max-w-6xl mx-auto px-6">
        <SectionHeader>
          ...
          <p className="text-muted-foreground text-center text-balance font-medium">
            BitterBot is fully open source. Join our community and help shape the
            future of AI.
          </p>
        </SectionHeader>
          ...
          <div className="rounded-xl bg-[#F3F4F6] dark:bg-[#F9FAFB]/[0.02] border border-border p-6">
            <div className="flex flex-col gap-6">
              <div className="flex items-center gap-2 text-primary font-medium">
                ...
                <span>bitterbot-ai/bitterbot</span>
              </div>
              <div className="relative">
                ...
                <p className="text-muted-foreground mt-2">
                  Explore, contribute, or fork our repository. BitterBot is built
              ...
              <Link
                href="https://github.com/bitterbot-ai/bitterbot"
                target="_blank"
