...
# Type hint for langfuse trace client
...
async def run_agent(
    ...
    # If no agent config (enabled_tools is None), register ALL tools for full Bitterbotcapabilities
    ...
    if enabled_tools is None:
        # No agent specified - register ALL tools for full Bitterbot experience
        logger.info("No agent specified - registering all tools for full Bitterbot capabilities")
